...
public class WheelView extends ScrollView {
    ...
    private void refreshItemView(int y) {
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(context.getResources().getColor(
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.e(TAG, "w: " + w + ", h: " + h + ", oldw: " + oldw + ", oldh: "
                + oldh);
        viewWidth = w;
    ...
    public void setWheelViewData(int offset, List list, String defaultStr) {
        setOffset(offset);
        setItems(list);
        setPressureData(list, defaultStr);
    }

    @SuppressWarnings("rawtypes")
    private void setPressureData(List list, String defaultStr) {
        for (int i = 0; i < list.size(); i++) {
            if (list.get(i).equals(defaultStr)) {
                setSeletion(i);
            }
        }
    }
